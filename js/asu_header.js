...
(function (ASUHeader, undefined) {
    ...
    ASUHeader.generateSiteTitle = function () {
        var siteTitle = false;
        if (typeof ASUHeader.site_title !== 'undefined' && typeof ASUHeader.site_title.title !== 'undefined') {
            if (typeof ASUHeader.site_title.parent_org !== 'undefined') {
    ...
    // display alternate innovation footer logo ~50% of the time
    function generateInnovationFooter() {
        var rand = Math.random();

        if (rand < .5) {
            var alternate = document.getElementById('innovation-footer-left').innerHTML;
            var standard = document.getElementById('innovation-footer-right');

            standard.innerHTML = alternate;
        }
    }
    ...
    function createSearch(parent) {
        ...
        if (typeof ASUHeader !== 'undefined' && ASUHeader.gsa) {
            ...
            addInpt(form, 'text', 'search_header', 'asu_search_box', boxid, '', 'Search');
