  ...
  function asuCookieConsent(cookieDomain) {
    ...
    var customElements = {
      ...
      messagelink:
        '<span id="cookieconsent:desc" class="cc-message">{{message}}</span>',
      dismiss:
        '<a aria-label="privacy statement" tabindex="0" class="asu-cc-btn" href="{{href}}" target="_blank">{{link}}</a><a aria-label="dismiss cookie message" tabindex="0" class="cc-btn cc-dismiss asu-cc-btn">{{dismiss}}</a>'
    };
